...
% 
required_options_to_multi_part=[required_options_to_multi_part,{sprintf('ray_blocks=%i', pda{end}.headfile.dim_Z*numel(scan_ids)),sprintf('dim_Z=%i',pda{end}.headfile.dim_Z*numel(scan_ids)),sprintf('fovz=%i', pda{end}.headfile.fovz*numel(scan_ids))}];
