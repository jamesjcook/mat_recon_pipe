...
% scanner when a four element array coil is used.
...
runno=['00' num2str(init_runno+i)]; %Initial run number (needs to be string for now)
host_data_dir='20111007.dL1';
host_scan_dir=init_dir+i; %Not a string
...
% Nyquist_cutoff=25; %Look at script Find_Nyquist_cutoff.m
% for i=1:keyhole
...
%         di(:,(2*mat2+1):(2*mat2+Nyquist_cutoff),ind_not_acq)=NaN; %Channel 3
%         di(:,(3*mat2+1):(3*mat2+Nyquist_cutoff),ind_not_acq)=NaN; %Channel 4
%         
...
%         Bruker_recon_3Dradial_4element_array_coil(runno, dv, kv, dcfv, mat, j, i)
%     end
%     
% end