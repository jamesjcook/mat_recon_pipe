options={'existing_data','overwrite','warning_pause=0','debug_mode=50','skip_write_civm_raw','skip_write_headfile','write_unscaled','skip_filter','use_new_bruker_padding'};%,'ignore_errors'};%,'ignore_kspace_oversize'};
